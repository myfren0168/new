...
echo color("red","        *** SLALU ADA JALAN ***   \n");
echo color("white","=====================================\n");
echo color("green","         JANGAN LUPA BERDOA                       \n");
echo color("nevy","      TERMUX GRATIS ORA MBAYAR                \n");
echo color("green","        NEK GK OLEH OJO NESU                      \n");
echo color("white","=====================================\n");
echo color("purple","======== WA GROUP @ CAK-CEK =========\n");
echo color("white","=====================================\n");
echo "Version  : 2020                       \n";
echo "Time     :".date('[d-m-Y] [H:i:s]')." \n";
echo color("purple","Create By: @Youdie77\n");
echo color("yellow"," ==JEMBOT GONDRONK==\n");
echo "\n";
// function change(){
        $nama = nama();
       ...
       // echo "\n".$claim;
        ...
        echo "\n \n";
          /*
        $boba09 = request1('/customer_referrals/v1/campaign/enrolment', $token, '{"referral_code":"G-ZDJYTYX"}');
